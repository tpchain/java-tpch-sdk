...
import static org.tpc.abi.TypeDecoder.MAX_BYTE_LENGTH_FOR_HEX_STRING;

/**
 * Tpchain Contract Application Binary Interface (ABI) encoding for functions. Further details are
